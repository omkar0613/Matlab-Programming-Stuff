...
%    prompt=('What is the arrival time for job ? : ');
%    Ai=input(prompt);
%    prompt=('What is the requested start time for job ? : ');
%    Si=input(prompt);
%    prompt=('What is the requested end time for job ? : ');
%    Ei=input(prompt);
...
countofNodes=1;
   while (di ~= si)                                                         % At this line, Djikstra Algorithm is implemented and we have whole matrix
        ...
        display (optimalPath);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        S      =100;             % Radiated Power at the Transmitter
        W      =10^(8);         % Bandwidth
